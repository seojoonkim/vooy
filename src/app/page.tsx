...
export default function Home() {
  ...
  // Blink animation — natural blink: 8-20s gap, one blink at a time
  useEffect(() => {
    if (!allLit) return;
      ...
      blinkTimeout = setTimeout(() => {
        ...
        setTimeout(() => {
          ...
          setTimeout(() => {
            ...
            setTimeout(() => {
              // Fully open — then schedule next blink
  ...
  return (
    <main style={{ position:"relative", height:"100dvh", minHeight:"100dvh", maxHeight:"100dvh", background:"linear-gradient(160deg,#050a0d 0%,#020810 55%,#05050a 100%)", display:"flex", flexDirection:"column", alignItems:"center", justifyContent:"center", overflow:"hidden", fontFamily:"'Helvetica Neue',Helvetica,Arial,sans-serif" }}>
      ...
      {/* Center glow */}
      <div style={{ position:"absolute", top:"50%", left:"50%", transform:"translate(-50%,-50%)", width:"min(500px,70vw)", height:300, borderRadius:"50%", background:`radial-gradient(ellipse, rgba(0,180,255,0.08) 0%, rgba(0,212,255,0.03) 40%, transparent 70%)`, pointerEvents:"none" }} />
        ...
        <div ref={heroRef} style={{ position:"relative", animation:"fadeSlide 0.8s 0.15s ease both", opacity:0, willChange:"transform" }}>
          <svg
            ...
            style={{
              ...
              display: "block",
              filter: allLit
                ? "drop-shadow(0 0 2px rgba(0,212,255,0.3)) drop-shadow(0 0 6px rgba(0,212,255,0.1))"
                : "none",
